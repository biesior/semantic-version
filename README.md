...
[![State](https://img.shields.io/static/v1?label=alpha&message=0.0.9&color=blue 'Latest known version')](https://github.com/biesior/version-updater/tree/0.0.9-alpha) <!-- __SEMANTIC_VERSION_LINE__ -->
![Updated](https://img.shields.io/static/v1?label=upated&message=2020-08-22+04:09:51&color=lightgray 'Latest known update date') <!-- __SEMANTIC_UPDATED_LINE__ -->
